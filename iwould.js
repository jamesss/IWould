$(function() {
   ...
   * Selectors
   */
  //var LIKE_BUTTON_SELECTOR = '.UIImageBlock .commentable_item .UIActionLinks button.like_link .default_message, button.cmnt_like_link .default_message';
   ...
   * Replacement strings
   */
  var LIKE_REPLACE = 'Phwoaar, I would!';
  var UNLIKE_REPLACE = 'Wouldn\'t touch that with someone else\'s!';
  var LIKE_THIS_REPLACE = 'would';
  var LIKES_THIS_REPLACE = 'would do ten years for this ass';
